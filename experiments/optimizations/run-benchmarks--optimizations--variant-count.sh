...
for scale_factor in 1.0  # 0.5 1.0 1.5 2.0 2.5 3.0
do
...
#    PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python python3.9 benchmarks--optimization.py operator_deletion_filter_push_up worst_case_only_some_filters_worth_pushing_up "$variant_count" "$scale_factor"
    ...
    PROTOCOL_BUFFERS_PYTHON_IMPLEMENTATION=python python3.9 benchmarks--optimization.py filter_addition_push_up worst_w_original_w_heuristic "$variant_count" "$scale_factor"
