...
#
#     def clean(self, dirty_train, dirty_test):
#         indicator_train = pd.DataFrame(np.any(self.clean_train.values != dirty_train.values, axis=1),
#                                        columns=['indicator'])
#         indicator_test = pd.DataFrame(np.any(self.clean_test.values != dirty_test.values, axis=1),
#                                       columns=['indicator'])
