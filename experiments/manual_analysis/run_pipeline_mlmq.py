...
def get_dataset(dataset_name, data_loading_name, featurization_name):
    if dataset_name in {'reviews', 'reviews_5x', 'reviews_10x'}:
    ...
    elif dataset_name in {'folktables', 'folktables_5x', 'folktables_10x'}:
...
def main_function(*args, **kwargs):
    ...
    train, train_labels, test, test_labels, numerical_columns, categorical_columns, text_columns = \
        get_dataset(dataset_name, data_loading_name, featurization_name)
