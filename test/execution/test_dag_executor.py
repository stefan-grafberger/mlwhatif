...
from mlwhatif.analysis._analysis_utils import get_intermediate_extraction_patch_after_node
...
def execute_dag_and_get_final_pipeline_result(extracted_dag):
    ...
    label = "dag-exec-test"
    get_intermediate_extraction_patch_after_node(extracted_dag, final_result_op, label)
